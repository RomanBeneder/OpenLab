## Generated SDC file "fpga_top.sdc"
...
create_generated_clock -name {clk25} -source [get_pins {clk~input|o}] -duty_cycle 50.000 -multiply_by 1 -divide_by 2 -master_clock {clk} [get_pins { i_prescaler|altpll_component|auto_generated|pll1|clk[0] }] 
