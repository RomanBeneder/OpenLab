...
SOPCINFO_FILE := C:/altera/workspace/demo/first_nios2_system.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x10030
SOPC_SYSID_FLAG += --sidp=0x10030
ELF_PATCH_FLAG  += --sidp 0x10030

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1433946476
SOPC_SYSID_FLAG += --timestamp=1433946476
ELF_PATCH_FLAG  += --timestamp 1433946476
